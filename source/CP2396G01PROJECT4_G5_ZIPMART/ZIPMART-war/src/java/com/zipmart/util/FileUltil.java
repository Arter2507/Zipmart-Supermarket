        ...
        if (file != null) {
            try {
                ...
                try {
                    ...
                    imagePath = "images\\uploads" + File.separator + file.getSubmittedFileName();
                    ...
                    System.out.println("-------------------------File uploaded faillllllllllllllllllllllllllllllll!");
                } finally {
                ...
                Logger.getLogger(FileUltil.class.getName()).log(Level.SEVERE, null, ex);
                System.out.println("-------------------------File uploaded failExxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx!");
            }
        }
        return imagePath;
    }
